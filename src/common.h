/*
    Structures, macros and constants used by codecs and most modules
    Maybe it should be named ahtse.h at some point, and moved to its own library
 */
...
// For png_color_16, maybe we can get rid of it?
#include <png.h>
#include <apr.h>
